...
class AddFeedback extends StatefulWidget {
  ...
  AddFeedback({Key key, this.uName, this.uEmail, this.uPhoto})
      : super(key: key);

  @override
  _AddFeedbackState createState() => _AddFeedbackState(uName, uEmail, uPhoto);
}
...
class _AddFeedbackState extends State<AddFeedback> {
  ...
  _AddFeedbackState(this.uName, this.uEmail, this.uPhoto);
  ...
  mail() async {
    ...
    final message = Message()
      ...
      ..subject =
          '$uName your Feedback of our app (Go See..!) is successfully submitted on $date $time.'
      ..text =
          'Dear $uName, \n \n      Your Feedback of our app (Go See..!) is very valuable '
              'for our other users.\n \n                                  '
              'Thank You $uName for giving your valuable time with us \n\nRegard: Go See..!';
    ...
    return new Column(
      children: <Widget>[
        ...
        new TextFormField(
          ...
          decoration:
              new InputDecoration(hintText: 'Write your feedback of Go See...!'),
          onSaved: (String val) {
            _review = val;
          },
        ),
  ...
  _sendToServer() {
    if (_key.currentState.validate()) {
      ...
      Firestore.instance.runTransaction((Transaction transaction) async {
        ...
        await reference.document('$uEmail').setData({
          "review": "$_review",
          "user_email": "$uEmail",
          "user_name": "$uName",
          "user_photo": "$uPhoto",
